...
Wij hebben deze bevinding gevisualiseerd in een boxplot, zie de plot(‘ Salary vs Company size’). Iets wat gelijk op te merken is aan de boxplot is dat de meduim bedrijven de grootste uitschieters hebben van salarissen.
